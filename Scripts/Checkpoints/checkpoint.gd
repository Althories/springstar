extends Area3D
#USAGE
#--This general use area script can be edited for any Checkpoint node
...
func _ready() -> void:
	...
	respawn_pos = global_position	#fetches objective Area3D position in world
